  ...
  changeLang(change?: any) {
    ...
    if (localStorage.getItem('language') === 'tamil') {
      ...
      this.language = {
        ...
        sibilingsHint:
          'உங்களின் உடன் பிறந்தோர் மொத்த எண்ணிக்கையை உள்ளிடவும்.',
        sibilingsData: '',
...
'சிக்கல்கள் ஏதுமில்லை ',
        ...
        sectorInterested:
          ...
          accessedGovtSchemes:'கல்விக்காக நீங்கள் இதுவரை பெற்ற அரசு திட்டங்கள் யாவை ?',
...
*/
        ...
        graduationAwayFromHometown:
          ...
          accessedGovtSchemes:'What are the Govt schemes you have accessed so far for Education? ',
